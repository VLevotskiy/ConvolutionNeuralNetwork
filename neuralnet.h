...
public:
    NeuralNet(std::string* layers_discription, uint16_t num_of_layers, double training_threshold_ = 0.0001, double training_speed_ = 0.1, double inertia_coeff_ = 0.05);
